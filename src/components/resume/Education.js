  ...
  return (
    ...
    >
      <div className="py-12 font-titleFont">
        ...
        <h2 className="text-4xl font-bold mt-3">Education Quality</h2>
      </div>
      <div className="mt-10 w-full h-[950px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
        <ResumeCard
